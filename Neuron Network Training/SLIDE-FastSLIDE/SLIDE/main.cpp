...
int main(int argc, char* argv[])
{
    ...
    float timeMiliseconds = std::chrono::duration_cast<std::chrono::microseconds>(tt2 - tt1).count();
    std::cout << "All Training Time " << timeMiliseconds/1000000 << " seconds" << std::endl;
