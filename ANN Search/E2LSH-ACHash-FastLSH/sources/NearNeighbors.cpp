...
Int32T getRNearNeighbors(PRNearNeighborStructT nnStruct, PPointT queryPoint, PPointT *(&result), Int32T &resultSize, int &num){
...
//   DPRINTF("Estimated Dist comp time (query specific): %0.6lf\n", distComp * estNColls);
  ...
  Int32T nNearNeighbors = getNearNeighborsFromPRNearNeighborStruct(nnStruct, queryPoint, result, resultSize, num);
...
Int32T FgetRNearNeighbors(PRNearNeighborStructT nnStruct, PPointT queryPoint, PPointT *(&result), Int32T &resultSize, int &num, int subdim)
{
  DPRINTF("Estimated ULSH comp: %0.6lf\n", lshPrecomp * nnStruct->nHFTuples * nnStruct->hfTuplesLength);
  DPRINTF("Estimated UH overhead: %0.6lf\n", uhashOver * nnStruct->nHFTuples);
  timeRNNQuery = 0;
  ...
  Int32T nNearNeighbors = FgetNearNeighborsFromPRNearNeighborStruct(nnStruct, queryPoint, result, resultSize, num, subdim);
...
Int32T R2getRNearNeighbors(PRNearNeighborStructT nnStruct, PPointT queryPoint, PPointT *(&result), Int32T &resultSize, int &num, int subdim)
{
  DPRINTF("Estimated ULSH comp: %0.6lf\n", lshPrecomp * nnStruct->nHFTuples * nnStruct->hfTuplesLength);
  DPRINTF("Estimated UH overhead: %0.6lf\n", uhashOver * nnStruct->nHFTuples);
  timeRNNQuery = 0;
  ...
  Int32T nNearNeighbors = R2getNearNeighborsFromPRNearNeighborStruct(nnStruct, queryPoint, result, resultSize, num, subdim);
